...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background: url(files/perepoloh/sky_background.png) no-repeat center fixed;")
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.vinni = QtWidgets.QFrame(self.centralwidget)
        self.vinni.setGeometry(QtCore.QRect(10, 260, 101, 250))
        self.vinni.setStyleSheet("background: url(files/perepoloh/vinnipuh.jpg);\n"
                                 "border: 0px solid;")
        ...
        self.bees.setStyleSheet("background: url(files/perepoloh/bees.jpg);\n"
                                "border: 0px solid;")
